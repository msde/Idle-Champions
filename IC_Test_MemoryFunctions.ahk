...
Gui, MyWindow:Add, Text, vReadHighestZoneID x+2 w300,

;Gui, MyWindow:Add, Text, x15 y+5, ReadAreaLevel: 
;Gui, MyWindow:Add, Text, vReadAreaLevelID x+2 w300,
...
Gui, MyWindow:Add, Text, x15 y+5, ReadChampSlotByID: 
Gui, MyWindow:Add, Text, vReadChampSlotByIDID x+2 w300,

Gui, MyWindow:Add, Text, x15 y+5, ReadChampBenchedByID: 
Gui, MyWindow:Add, Text, vReadChampBenchedByIDID x+2 w300,
...
;Gui, MyWindow:Add, Text, vReadFormationSavesSizeID x+2 w300,

;Gui, MyWindow:Add, Text, x15 y+5, ReadFormationFavoriteIDBySlot: 
;Gui, MyWindow:Add, Text, vReadFormationFavoriteIDBySlotID x+2 w300,

;Gui, MyWindow:Add, Text, x15 y+5, ReadFormationSaveBySlot: 
;Gui, MyWindow:Add, Text, vReadFormationSaveBySlotID x+2 w300,

;Gui, MyWindow:Add, Text, x15 y+5, ReadFormationNameBySlot: 
;Gui, MyWindow:Add, Text, vReadFormationNameBySlotID x+2 w300,
...
CheckReads()
{
    ...
    ;ReadFormationSaveBySlot(1)
    ;ReadFormationNameBySlot(1)
}
